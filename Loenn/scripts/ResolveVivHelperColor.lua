...
function script.prerun(args, mode, ctx) 
    ...
    for _, room in ipairs(state.map.rooms) do 
        for _, entity in ipairs(room.entities) do
            if vivUtil.contains(SimpleColors, entity._name) and entity.Color then
                entity.color = vivUtil.swapRGBA(entity.Color)
                entity.Color = nil
            elseif entity._name == "VivHelper/WrapperRefillWall" and entity.InnerColor then
            ...
            elseif (entity._name == "VivHelper/TravelingFlame" or entity._name == "VivHelper/TravelingFlameCurve") and entity.ColorTint then
            ...
            elseif (entity._name == "VivHelper/Spawnpoint" or entity._name == "VivHelper/InterRoomSpawner" or
                   entity._name == "VivHelper/InterRoomSpawnTarget" or entity._name == "VivHelper/InterRoomSpawnTarget2") and entity.Color then
                entity.color = vivUtil.swapRGBA(entity.Color)
                entity.Color = nil
                entity.outlineColor = vivUtil.swapRGBA(entity.OutlineColor)
                entity.OutlineColor = nil
            elseif (entity._name == "VivHelper/HoldableBarrierController" or "VivHelper/HoldableBarrierController2") and entity.ParticleColor then
            ...
            elseif entity._name == "VivHelper/nWayDashBlock" and entity.DetailColor then
                entity.detailColor = vivUtil.swapRGBA(entity.DetailColor)
                entity.DetailColor = nil
            elseif entity._name == "VivHelper/CrystalBombDetonatorController" and entity.ParticleColor then
                entity.particleColor = vivUtil.swapRGBA(entity.ParticleColor)
                entity.ParticleColor = nil
                entity.baseColor = vivUtil.swapRGBA(entity.BaseColor)
                entity.BaseColor = nil
            elseif entity._name == "VivHelper/Collectible" and entity.particleColor then
                entity.ParticleColor = vivUtil.swapRGBA(entity.particleColor)
                entity.particleColor = nil
            elseif entity._name == "VivHelper/CustomBirdPath" and entity.TrailColor then
                entity.trailColor = vivUtil.swapRGBA(entity.TrailColor)
                entity.TrailColor = nil
            elseif entity._name == "VivHelper/CustomHangingLamp" and entity.LightAlpha then
            ...
            elseif (entity._name == "VivHelper/CurvedZipMover" or entity._name == "VivHelper/CurvedZipMover2" or entity._name == "VivHelper/CustomZipMover" or
                   entity._name == "VivHelper/CrumblingZipMover" or entity._name == "VivHelper/CustomCrumblingZipMover" or entity._name == "VivHelper/CurvedCrumblingZipMover")
                   and entity.RopeColor then
                ...
                entity.baseColor = vivUtil.swapRGBA(entity.BaseColor)
                entity.BaseColor = nil
            elseif entity._name == "VivHelper/CustomTorch" and entity.Color then
                entity.color = vivUtil.swapRGBA(entity.Color)
                entity.Color = nil
            ...
            elseif entity._name == "VivHelper/DashTempleGate" and entity.BeamColor then
                entity.beamColor = vivUtil.swapRGBA(entity.BeamColor)
                entity.BeamColor = nil
            elseif entity._name == "VivHelper/CustomSpinner" or entity._name == "VivHelper/AnimatedSpinner" and entity.Color then
                entity.color = vivUtil.swapRGBA(entity.Color)
                ...
                entity.Type = nil
            elseif entity._name == "VivHelper/CassetteTileEntity" and entity.enabledTint then
        ...
        for _, trigger in ipairs(room.triggers) do
            if (trigger._name == "VivHelper/BasicInstantTeleportTrigger" or trigger._name == "VivHelper/MainInstantTeleportTrigger" or trigger._name == "VivHelper/CustomInstantTeleportTrigger") and entity.Color then
