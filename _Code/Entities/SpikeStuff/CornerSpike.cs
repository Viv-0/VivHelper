    ...
    public class CornerSpike : CustomSpike {
        ...
        internal static Dictionary<string, Action<CornerSpike>> attrToAction = new Dictionary<string, Action<CornerSpike>>(4)
        {
            ...
            {"DownLeft", c =>
            {
                ...
                c.image.RenderPosition = Variables.UR;
                if (c.InnerSpike)
                {
            ...
            {"UpRight", c =>
            {
                ...
                c.image.RenderPosition = Variables.DL;
                if (c.InnerSpike)
                {
        ...
        private bool IsRiding(Solid solid) {
            switch (Direction) {
                ...
                case DirectionPlus.DownLeft:
                    return CollideCheckOutside(solid, Position + Variables.UR);
                case DirectionPlus.UpRight:
                    return CollideCheckOutside(solid, Position + Variables.DL);
