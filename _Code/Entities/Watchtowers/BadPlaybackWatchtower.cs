...
namespace VivHelper.Entities {
    ...
    [CustomEntity("VivHelper/BadPlaybackWatchtower")]
    public class BadPlaybackWatchtower : Entity {
        ...
        public BadPlaybackWatchtower(EntityData data, Vector2 offset)
        ...
        public override void Awake(Scene scene) {
            base.Awake(scene);
            playback = null;
            playback = base.Scene?.Entities.FindFirst<PlayerPlayback>();
            if (playback != null)
                playback.RemoveSelf();
        }
