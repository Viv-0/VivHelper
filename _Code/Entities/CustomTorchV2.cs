...
namespace VivHelper.Entities {
    ...
    public class CustomTorch2 : Entity {
        ...
        public CustomTorch2(EntityData data, Vector2 offset, EntityID id) : base(data.Position + offset) {
            ...
            color = VivHelper.GetColorWithFix(data, "Color", "color", VivHelper.GetColorParams.None, VivHelper.GetColorParams.None, Color.Cyan).Value;//VivHelper.OldColorFunction(data.Attr("Color", "Cyan"));
            ...
            sprite.Color = VivHelper.GetColor(data.Attr("spriteColor"), VivHelper.GetColorParams.None, Color.White).Value;
            Add(sprite);
