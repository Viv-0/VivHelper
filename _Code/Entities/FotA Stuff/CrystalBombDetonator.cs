...
namespace VivHelper.Entities {
    ...
    public class CrystalBombDetonator2 : Solid {
        ...
        public override void Render() {
            Color[] colors = new Color[] { colorController?.particleColor ?? Calc.HexToColor(VivHelperModule.Session.savedCBDController?.particleColorHex ?? VivHelperModule.defaultCBDController.particleColorHex), colorController?.baseColor ?? Calc.HexToColor(VivHelperModule.Session.savedCBDController?.baseColorHex ?? VivHelperModule.defaultCBDController.baseColorHex) };
            colors[0] *= 0.5f;
            colors[1] *= 0.5f;
