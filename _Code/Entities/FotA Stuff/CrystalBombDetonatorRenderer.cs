...
namespace VivHelper.Entities {
    ...
    public class CrystalBombDetonatorRenderer : Entity {
        ...
        public override void Render() {
            ...
            Color color = (colorController?.baseColor ?? VivHelper.ColorFix(VivHelperModule.Session.savedCBDController?.baseColorHex ?? VivHelperModule.defaultCBDController.baseColorHex)) * 0.5f;
            foreach (CrystalBombDetonator2 crystalBombDetonator in trackedFields) {
                if (crystalBombDetonator.Visible)
