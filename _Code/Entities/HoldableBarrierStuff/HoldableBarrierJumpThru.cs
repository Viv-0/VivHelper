...
namespace VivHelper.Entities {
    ...
    public class HoldableBarrierJumpThru : JumpThru {
        ...
        public override void Awake(Scene scene) {
            ...
            Collidable = true;
            innerC = (colorController?.particleColor ?? Calc.HexToColorWithAlpha(VivHelperModule.Session.savedHBController?.particleColorHex ?? VivHelperModule.defaultHBController.particleColorHex)) * 0.5f;
            outerC = (colorController?.baseColor ?? Calc.HexToColorWithAlpha(VivHelperModule.Session.savedHBController?.baseColorHex ?? VivHelperModule.defaultHBController.baseColorHex)) * 0.5f;
